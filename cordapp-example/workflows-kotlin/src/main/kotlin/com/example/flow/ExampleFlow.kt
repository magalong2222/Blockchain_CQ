...
object ExampleFlow {
    @InitiatingFlow
    @StartableByRPC
    class Initiator(val iouCash: Int,
                    val iouOil: Int,
        ...
        override fun call(): SignedTransaction {
            ...
            val iouState = IOUState(iouCash, iouOil, otherParty, serviceHub.myInfo.legalIdentities.first())
        ...
        override fun call(): SignedTransaction {
            val signTransactionFlow = object : SignTransactionFlow(otherPartySession) {
                override fun checkTransaction(stx: SignedTransaction) = requireThat {
                    ...
                    "I won't accept IOUs with a value over 100000." using (iou.cash <= 100000)
                }
            }
