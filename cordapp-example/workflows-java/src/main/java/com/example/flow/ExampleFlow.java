...
public class ExampleFlow {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public Initiator(int cashValue, int oilValue, Party otherParty) {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            IOUState iouState = new IOUState(cashValue, oilValue, otherParty, me, new UniqueIdentifier());
            final Command<IOUContract.Commands.Create> txCommand = new Command<>(
                    new IOUContract.Commands.Create(),
                    ImmutableList.of(iouState.getSeller().getOwningKey(), iouState.getBuyer().getOwningKey()));
            ...
            class SignTxFlow extends SignTransactionFlow {
                ...
                protected void checkTransaction(SignedTransaction stx) {
                    requireThat(require -> {
                        ...
                        require.using("I won't accept IOUs with a value over 100000.", iou.getcashValue() <= 100000);
                        return null;
                    });
                }
            }
